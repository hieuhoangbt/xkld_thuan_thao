...
class wp_bootstrap_navwalker extends Walker_Nav_Menu {
    ...
    function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0) {
        ...
        $subMn ='';
        $depth == 0 ?
            $item_output = sprintf('%1$s<a%2$s>%3$s%4$s%5$s%6$s</a>%7$s', $args->before, $attributes . 'class="menu-parent" '. $collapse, $args->link_before, apply_filters('the_title', $item->title, $item->ID), $args->link_after, $caret, $args->after
            ) :
