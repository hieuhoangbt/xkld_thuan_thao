...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="form-group col-lg-6">
            <label>Address : </label>
            <input type="text" name="register-information[address]" value="<?php echo esc_attr($data["address"]); ?>"
                   class="form-control">
        </div>
    </div>
    <div class="row">
        <div class="form-group col-lg-6">
            ...
            <input type="text" name="register-information[phone_number]"
                   value="<?php echo esc_attr($data["phone_number"]); ?>"
                   class="form-control">
        </div>
        <div class="form-group col-lg-6">
            <label>Email : </label>
            <input type="text" name="register-information[email]" value="<?php echo esc_attr($data["email"]); ?>"
                   class="form-control">
        </div>
    </div>
    <div class="row">
